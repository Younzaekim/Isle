...
public class SoundToFootstepTrigger : MonoBehaviour
{
    private SurfaceSensor surfaceSensor;
    private FootstepPlayer footstepPlayer;
    private PlayerController_Test playerController; //컨트롤러 정보
    ...
    private void Awake()
    {
        ...
        playerController = GetComponent<PlayerController_Test>(); //컨트롤러 정보
    }
